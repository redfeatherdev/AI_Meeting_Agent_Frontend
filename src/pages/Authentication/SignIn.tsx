...
import { useAuthStore } from '../../store'; import { toast } from 'sonner';
;

const SignIn: React.FC = () => {
  const navigator = useNavigate();
  const { logIn } = useAuthStore() as { logIn: (access: string, refresh: string) => void };

  // const connectWithGoogle = async () => {
  //   try {
  //     const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/v1/auth/google/`);
  ...
  return (
    <>
      <div className="flex h-screen justify-center items-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="w-full h-full flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 flex flex-col justify-center items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold te defaults={'username': username}xt-black dark:text-white sm:text-title-xl2">
                Sign In to NoTaq
              </h2>
